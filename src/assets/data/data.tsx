...
export const heroData = {
  teams: [
    ...
    },
    {
      ...
      heroText:
        "대전의 역사적인 명소와 최신 랜드마크를 함께 즐길 수 있는 여행!\n이글스와 함께하는 전통 시장 탐방과 최신 테마파크 체험.",
    },
    {
      id: 3,
      teamName: "KIA 타이거즈",
      ...
      heroText:
        "광주의 전통 문화와 현대 예술을 경험하세요!\n타이거즈와 함께하는 문화 유산 탐방과 예술 갤러리 투어.",
    },
    {
      id: 4,
      teamName: "LG 트윈스",
      region: "잠실",
      heroImage: "https://yaguhang.kro.kr:8443/stadiums/jamsilStadium.jpeg",
      teamLogo: "https://yaguhang.kro.kr:8443/teamLogos/LGTwins.png",
      heroTitle: "LG 트윈스와 함께하는\n잠실의 핫플레이스 탐방",
      heroText:
        "잠실의 최신 핫플레이스와 전통 명소를 함께 즐기세요!\nLG 트윈스와 함께하는 잠실 구장 주변 명소 탐방과 인기 맛집 투어.",
    },
    {
      id: 5,
      teamName: "두산 베어스",
    ...
    },
    {
      ...
      teamLogo: "https://yaguhang.kro.krƒ8443/teamLogos/SSGLanders.png",
      heroTitle: "SSG 랜더스와 함께하는\n인천의 바다와 해양 스포츠",
      heroText:
        "인천의 해양 스포츠와 해변을 즐기세요!\nSSG 랜더스와 함께하는 바다 탐방과 해양 액티비티.",
    },
    {
      id: 10,
      teamName: "NC 다이노스",
